...
string konversiPostfix(Node *top, string infix)
{
    int step = 1;
    string postfix = "";
...
double hitungPostfix(Node *top, string postfix)
{
...
int main()
{
    ...
    postfix = konversiPostfix(top, infix);
    top = NULL;

    cout << endl;
    cout << "Konversi postfix: " << postfix << endl;
    cout << "Hasil kalkulasi: " << hitungPostfix(top, postfix) << endl;
